...
🛎备注：本项目复制于[daibor](https://github.com/daibor)的项目[nonsense.fun](https://github.com/daibor/nonsense.fun)，部分index.html 的代码有修改，仅作为日常自己的小声BB使用，不做任何商业上的使用。参考少数派文章[《保卫表达：用后端 BaaS 快速搭建专属无点赞评论版微博——b言b语》](https://sspai.com/post/60024) 搭建。如果大家需要建立，可以fork 原作者的仓库更改相关的ID和Key 值即可。 
# 关于
